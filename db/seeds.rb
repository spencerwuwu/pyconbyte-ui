...
codetest = [
  ...
  { 
    ...
    question: "<p>Source: <a href=\"https://leetcode.com/problems/longest-substring-without-repeating-characters/\">https://leetcode.com/problems/longest-substring-without-repeating-characters/</a></p><p>Given a string, find the length of the longest substring without repeating characters.</p></br><h4>Example&nbsp1:</h4><strong>Input:&nbsp&nbsp</strong>\"abcabcbb\"</br><strong>Output:&nbsp&nbsp</strong>3</br><strong>Explanation:&nbsp&nbsp</strong>The answer is \"abc\", with the length of 3.</br><h4>Example&nbsp2:</h4><strong>Input:&nbsp&nbsp</strong>\"bbbbbbb\"</br><strong>Output:&nbsp&nbsp</strong>1</br><strong>Explanation:&nbsp&nbsp</strong>The answer is \"b\", with the length of 1.</br><h4>Example&nbsp3:</h4><strong>Input:&nbsp&nbsp</strong>\"pwwkew\"</br><strong>Output:&nbsp&nbsp</strong>3</br><strong>Explanation:&nbsp&nbsp</strong>The answer is \"wke\", with the length of 3.              Note that the answer must be a substring, \"pwke\" is a subsequence and not a substring.</br>"
  }
]
