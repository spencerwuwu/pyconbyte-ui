...
def get_result_sets(path, module, in_ret_sets, is_formal):
    ...
    for sets in in_ret_sets:
        ...
        if ret != sets["result"]:
            ...
            if is_formal:
                print("Input generated by yours: %s" % sets["input"])
                print("Correct output: %s" % ret)
                print("Yours: %s" % sets["result"])
            else:
                print("Input generated by ours: %s" % sets["input"])
                print("Correct output: %s" % sets["result"])
                print("Yours: %s" % ret)
            result = False
            break
